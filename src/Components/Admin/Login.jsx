...
const Login = () => {
  ...
  const handleLogin = () => {
    dataAdmin.map((data) => {
      ...
      } else navigate(`/dashboard-admin/${data.id_admin}`);
    });
  };
    ...
    <div className="login">
      ...
      <div className="bg d-flex justify-content-center">
        <div className="form-login p-5">
          ...
          <label
            className="label d-flex justify-content-start mt-2"
            htmlFor="email "
          >
            Password
          </label>
          ...
          <div className="row" style={{ height: "100%" }}>
            <div className="col d-flex align-items-center justify-content-center">
              <button className="but-beranda" onClick={() => navigate("/")}>
                Beranda
              </button>
            </div>
            <div className="col d-flex align-items-center justify-content-center">
              <button className="but-login-admin" onClick={handleLogin}>
                Login
              </button>
            </div>
          </div>
