    ...
    return ( 
        <div className="mading-admin container py-3">
            ...
            <div className="judul-admin mb-5">
                <p className="text-judul-admin d-flex align-items-center justify-content-center">Manajemen Mading</p>
            </div>

            <div className="input-mading d-flex justify-content-start my-2">
                <button className='but-input-mading' onClick={handleInputMading}>Input Mading</button>
            </div>
                    ...
                    <tbody>
                        {dataMading?.map((data, index)=>{
                            ...
                            <tr>
                                ...
                                <td>
                                    <button className='but-mading btn btn-warning mx-1'>Edit</button>
                                    <button className='but-mading btn btn-danger mx-1' onClick={(e) =>handleHapus(e, data.id_mading)}>Hapus</button>
                                </td>
                            </tr>
                        )    
                            })}
