    ...
    return ( 
        <div className="input-mading container">
             <div className="judul-admin-sub">
                <p className="text-judul-admin d-flex align-items-center justify-content-center">Input Mading</p>
            </div>
            ...
            <div className="form-input-mading m-5 px-5">
                <div className="row">
                    ...
                    <div className="col d-flex justify-content-start">
                        <input type="text" className='input-input-mading px-1' onChange={handleInput} id='judul_mading'/>
                    </div>
                </div>
                ...
                <div className="row">
                    ...
                    <div className="col d-flex justify-content-start">
                        <textarea type="text" className='input-isi-mading px-1' onChange={handleInput} id='isi_mading'/>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-but-input-mading row">
                <div className="col d-flex justify-content-end">
                    <button className='but-input-admin btn btn-outline-danger' onClick={handleBatal}>Batal</button>
                </div>
                <div className="col d-flex justify-content-start">
