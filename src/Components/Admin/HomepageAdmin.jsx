            ...
            <div className="row " style={{width:"100%"}}>
                <div className="col-2 p-0" style={{height:"100%"}}>
                    <div className="sidebar sticky-top py-4">
                        ...
                        <p className="text-jewepe-admin d-flex justify-content-center align-items-center">JeWePe</p>
                        </div>
                        ...
                        <div className="row d-flex justify-content-center">
                            ...
                            <div className={`${!isActiveKomentar ? `menu-sidebar` : `menu-sidebar-active`} my-1`} onClick={handleMenuKomentar}>
                                <p className="text-menu-sidebar d-flex align-items-center justify-content-start">&diams; Komentar</p>
                            </div>
                            <div className={`${!isActiveLaporan ? `menu-sidebar` : `menu-sidebar-active`} my-1`} onClick={handleMenuLaporan}>
                                <p className="text-menu-sidebar d-flex align-items-center justify-content-start">&diams; Laporan</p>
                            </div>
                        </div>

                        <div className="d-flex align-items-end justify-content-center" style={{height:'50%'}}>
                            <div className="">
