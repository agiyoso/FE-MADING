...
const MadingDetails = () => {
  ...
  useEffect(() => {
    ...
    if (dataKomentar.length !== 0) setIsKomen(true);
  }, []);
      ...
      <div className="row">
        ...
        <div className="col-4">
          <div className="bg-judul-komentar">
            <p className="text-judul-komentar d-flex align-items-center justify-content-center">
              Komentar
            </p>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="col p-0">
                      <p className="text-isi-komentar d-flex justify-content-start">
                        {data.isi_komen}
                      </p>
                    </div>
                  </div>
